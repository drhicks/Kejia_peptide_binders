...
# Add paths
sys.path.insert(0, '/home/drhicks1/scripts/mpnn_git_repo/ligandMPNN/')
...
argparser.add_argument("--use_ligand", type=int, default=0, help="0 for False, 1 for True; use ligand context")
...
argparser.add_argument("--backbone_noise", type=float, default=0.005, help="Standard deviation of Gaussian noise to add to backbone atoms")
