...
argparser.add_argument("--compute_input_sequence_score", type=int, default=0, help="0 for False, 1 for True")
...
argparser.add_argument( "--max_out", type=int, default=1, help='max outputs per target' )
